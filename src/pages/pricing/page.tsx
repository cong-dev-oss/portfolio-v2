...
export default function PricingPage() {
  ...
  const pricingSchema = {
    ...
    '@type': 'WebPage',
    name: 'Pricing | Find Your Tribe — Flexible Plans for Every Team',
    url: `${SITE_URL}/pricing`,
    description:
      'Choose the right plan for your business. Starter at $29/mo, Professional at $99/mo, and Enterprise with custom pricing. 14-day free trial, no credit card required.',
    breadcrumb: {
      '@type': 'BreadcrumbList',
      itemListElement: [
      ...
      itemListElement: [
        ...
        },
        {
          ...
          item: {
            ...
            eligibleQuantity: { '@type': 'QuantitativeValue', maxValue: 25 },
          },
        },
        {
          '@type': 'ListItem',
          ...
          item: {
            ...
            description: 'Custom pricing for large organizations at scale',
            price: '0',
            priceCurrency: 'USD',
          },
        },
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Yes! You can upgrade or downgrade your plan at any time. Changes take effect immediately, and we\'ll prorate any differences.',
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'We accept all major credit cards (Visa, MasterCard, American Express) and offer invoicing for annual Enterprise plans.',
        },
      },
      {
        '@type': 'Question',
      ...
      {
        '@type': 'Question',
        name: 'What happens when I exceed my data limit?',
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'We\'ll notify you when you\'re approaching your limit. You can upgrade your plan or purchase additional data points as needed.',
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Yes! We offer special pricing for nonprofits and educational institutions. Contact our sales team for details.',
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Absolutely. You can cancel your subscription at any time with no penalties. Your data will remain accessible for 30 days after cancellation.',
        },
      },
    ],
  };
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEOHead
        title="Pricing | Find Your Tribe — Flexible Plans, Free 14-Day Trial"
        description="Simple, transparent pricing for every team. Starter $29/mo, Professional $99/mo, Enterprise custom. 14-day free trial, no credit card required, cancel anytime."
        keywords="Find Your Tribe pricing, analytics pricing, SaaS pricing, free trial, Starter plan, Professional plan, Enterprise"
        canonical="/pricing"
