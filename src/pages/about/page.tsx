...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEOHead
        title="About Us | Find Your Tribe — AI Business Intelligence Platform"
        description="Learn about Find Your Tribe — our mission to empower businesses with AI-powered insights, meet our team, discover our values and the technology driving smarter decisions."
        keywords="Find Your Tribe, AI analytics company, business intelligence, about us, team, mission, data insights"
        canonical="/about"
        jsonLd={[
          {
            ...
            url: `${SITE_URL}/about`,
            description:
              'Find Your Tribe empowers businesses with AI-powered insights that drive smarter decisions and accelerate growth.',
            foundingLocation: {
              '@type': 'Place',
          ...
          },
          {
            '@context': 'https://schema.org',
            '@type': 'AboutPage',
            name: 'About Find Your Tribe',
            url: `${SITE_URL}/about`,
            description:
              'Mission, values and team behind Find Your Tribe — the AI business intelligence platform.',
            breadcrumb: {
              '@type': 'BreadcrumbList',
              itemListElement: [
